        ...
        public bool TrackSentEvent(string transEmailID, string userID, string toEmailAddress, string subject, string transGroupID, string sentTime, string openTrackEnabled, string clickTrackEnabled, string fromEmailAddress, string messageSize, string customID)
        {
            try{
                ...
                if (!string.IsNullOrEmpty(transGroupID))
                {
                    ...
                    {
                        if (!customID.ToUpper().Contains("TESTEMAIL"))
                        {
                            ...
                            commResult.NotifySender = NotifySender.EmailSent;
                            if (!string.IsNullOrEmpty(toEmailAddress))
                            {
                                commResult.CommunicationSource = toEmailAddress;
                            ...
                            commResult.Status = ResultStatus.Complete;
                            commResult.QueueStatus = ResultStatus.Complete;
                            commEmailResultStatistics.VendorTransID = transEmailID;

                            //RestCampaignRepository CampaignRepository = new RestCampaignRepository();

                            //CampaignRepository.SaveResult(commResult);

                            //************************************************************************************************//
                            //CommAPI.Data.SaveCampaignEmailResultsRequest campaignReq = new CommAPI.Data.SaveCampaignEmailResultsRequest();
                            //campaignReq.NotifySender = NotifySender.EmailSent;
                            //if (!string.IsNullOrEmpty(sentTime))
                            //    campaignReq.TimeOfComm = Convert.ToDateTime(sentTime);
                            //if (!string.IsNullOrEmpty(customID))
                            //{
                            //    string[] customIDParts = customID.Split('^');
                            //    if (customIDParts[0] != null)
                            //        campaignReq.QueueID = Convert.ToInt32(customIDParts[0].ToString());
                            //    if (customIDParts[1] != null)
                            //        campaignReq.CampaignTemplateID = Convert.ToInt32(customIDParts[1].ToString());

                            //}
                            //campaignReq.Status = ResultStatus.Complete;
                            //campaignReq.QueueStatus = ResultStatus.Complete;
                            //campaignReq.CommunicationSource = toEmailAddress;
                        
                            CommAPI.Services.Email.CampaignResultsService campaignResultsSvc = new CommAPI.Services.Email.CampaignResultsService();
                            campaignResultsSvc.SaveResults(commResult);
                ...
                if (!string.IsNullOrEmpty(transGroupID))
                {
                    if (transGroupID == ConfigurationManager.AppSettings.Get("Jango_TransGroupID_Campaign").ToString())
                    {
                        if (!customID.ToUpper().Contains("TESTEMAIL"))
                        {
                            ...
                            commResult.NotifySender = NotifySender.EmailOpened;
                            if (!string.IsNullOrEmpty(toEmailAddress))
                            {
                                commResult.CommunicationSource = toEmailAddress;
                                //commEmailResultStatistics.ToEmailAddress = toEmailAddress;
                            ...
                            //************************************************************************************************//
                            //CommAPI.Data.SaveCampaignEmailResultsRequest campaignReq = new CommAPI.Data.SaveCampaignEmailResultsRequest();
                            //campaignReq.NotifySender = NotifySender.EmailOpened;
                            //if (!string.IsNullOrEmpty(openTime))
                            //    campaignReq.TimeOfComm = Convert.ToDateTime(openTime);
                            //if (!string.IsNullOrEmpty(customID))
                            //{
                            //    string[] customIDParts = customID.Split('^');
                            //    if (customIDParts[0] != null)
                ...
                if (!string.IsNullOrEmpty(transGroupID))
                {
                    if (transGroupID == ConfigurationManager.AppSettings.Get("Jango_TransGroupID_Campaign").ToString())
                    {
                        if (!customID.ToUpper().Contains("TESTEMAIL"))
                        {
                            ...
                            commResult.NotifySender = NotifySender.EmailClicked;
                            if (!string.IsNullOrEmpty(toEmailAddress))
                            {
                                commResult.CommunicationSource = toEmailAddress;
                                //commEmailResultStatistics.ToEmailAddress = toEmailAddress;
                            ...
                            //************************************************************************************************//
                            //CommAPI.Data.SaveCampaignEmailResultsRequest campaignReq = new CommAPI.Data.SaveCampaignEmailResultsRequest();
                            //campaignReq.NotifySender = NotifySender.EmailClicked;
                            //if (!string.IsNullOrEmpty(clickTime))
                            //    campaignReq.TimeOfComm = Convert.ToDateTime(clickTime);
                            //if (!string.IsNullOrEmpty(customID))
                            //{
                            //    string[] customIDParts = customID.Split('^');
                            //    if (customIDParts[0] != null)
                ...
                if (!string.IsNullOrEmpty(transGroupID))
                {
                    if (transGroupID == ConfigurationManager.AppSettings.Get("Jango_TransGroupID_Campaign").ToString())
                    {
                        if (!customID.ToUpper().Contains("TESTEMAIL"))
                        {
                            ...
                            commResult.NotifySender = NotifySender.EmailBounced;
                            if (!string.IsNullOrEmpty(toEmailAddress))
                            {
                                commResult.CommunicationSource = toEmailAddress;
                                //commEmailResultStatistics.ToEmailAddress = toEmailAddress;
                            ...
                            //************************************************************************************************//
                            //CommAPI.Data.SaveCampaignEmailResultsRequest campaignReq = new CommAPI.Data.SaveCampaignEmailResultsRequest();
                            //campaignReq.NotifySender = NotifySender.EmailBounced;
                            //if (!string.IsNullOrEmpty(bounceTime))
                            //    campaignReq.TimeOfComm = Convert.ToDateTime(bounceTime);
                            //if (!string.IsNullOrEmpty(customID))
                            //{
                            //    string[] customIDParts = customID.Split('^');
                            //    if (customIDParts[0] != null)
                ...
                if (!string.IsNullOrEmpty(transGroupID))
                {
                    if (transGroupID == ConfigurationManager.AppSettings.Get("Jango_TransGroupID_Campaign").ToString())
                    {
                        if (!customID.ToUpper().Contains("TESTEMAIL"))
                        {
                            ...
                            commResult.NotifySender = NotifySender.EmailOptedOut;
                            if (!string.IsNullOrEmpty(toEmailAddress))
                            {
                                commResult.CommunicationSource = toEmailAddress;
                                //commEmailResultStatistics.ToEmailAddress = toEmailAddress;
                            ...
                            //************************************************************************************************//
                            //CommAPI.Data.SaveCampaignEmailResultsRequest campaignReq = new CommAPI.Data.SaveCampaignEmailResultsRequest();
                            //campaignReq.NotifySender = NotifySender.EmailOptedOut;
                            //if (!string.IsNullOrEmpty(unsubscribeTime))
                            //    campaignReq.TimeOfComm = Convert.ToDateTime(unsubscribeTime);
                            //if (!string.IsNullOrEmpty(customID))
                            //{
                            //    string[] customIDParts = customID.Split('^');
                            //    if (customIDParts[0] != null)
                ...
                if (!string.IsNullOrEmpty(transGroupID))
                {
                    if (transGroupID == ConfigurationManager.AppSettings.Get("Jango_TransGroupID_Campaign").ToString())
                    {
                        if (!customID.ToUpper().Contains("TESTEMAIL"))
                        {
                            ...
                            commResult.NotifySender = NotifySender.EmilComplaint;
                            if (!string.IsNullOrEmpty(toEmailAddress))
                            {
                                commResult.CommunicationSource = toEmailAddress;
                                //commEmailResultStatistics.ToEmailAddress = toEmailAddress;
                            ...
                            //************************************************************************************************//
                            //CommAPI.Data.SaveCampaignEmailResultsRequest campaignReq = new CommAPI.Data.SaveCampaignEmailResultsRequest();
                            //campaignReq.NotifySender = NotifySender.EmilComplaint;
                            //if (!string.IsNullOrEmpty(complaintTime))
                            //    campaignReq.TimeOfComm = Convert.ToDateTime(complaintTime);
                            //if (!string.IsNullOrEmpty(customID))
                            //{
                            //    string[] customIDParts = customID.Split('^');
                            //    if (customIDParts[0] != null)
