    ...
    public class ETLProcessor
    {
        ...
        public void Rebuild()
        {
            ...
            LoadPatientProblems(contract);
                //Has not been tested (PatientObservations to PatientTasks)
        ...
        private void LoadPatientObservations(string ctr)
            ...
            using (PatientObservationMongoContext poctx = new PatientObservationMongoContext(ctr))
            {
                ...
                foreach(MEPatientObservation obs in observations)
                {
                    ...
                    parms.Add(new Parameter("@Source", (string.IsNullOrEmpty(obs.Source.ToString()) ? string.Empty : obs.Source.ToString()), SqlDbType.VarChar, ParameterDirection.Input, 50));
                    ...
                    parms.Add(new Parameter("@Units", (string.IsNullOrEmpty(obs.Units.ToString()) ? string.Empty : obs.Units.ToString()), SqlDbType.VarChar, ParameterDirection.Input, 50));
        ...
        private void LoadObservations(string ctr)
        {
            using (PatientObservationMongoContext poctx = new PatientObservationMongoContext(ctr))
            {
                ...
                foreach (MEObservation obs in observations)
                {
                    ...
                    parms.Add(new Parameter("@Delete", (string.IsNullOrEmpty(obs.DeleteFlag.ToString()) ? string.Empty : obs.DeleteFlag.ToString()), SqlDbType.VarChar, ParameterDirection.Input, 50));
                    parms.Add(new Parameter("@Description", (string.IsNullOrEmpty(obs.Description) ? string.Empty : obs.Description), SqlDbType.VarChar, ParameterDirection.Input, 50));
                    ...
                    if (obs.ExtraElements != null)
                        parms.Add(new Parameter("@ExtraElements", obs.ExtraElements.ToString(), SqlDbType.VarChar, ParameterDirection.Input, 50));
                    else
                        parms.Add(new Parameter("@ExtraElements", string.Empty, SqlDbType.VarChar, ParameterDirection.Input, 50));
        ...
        private void LoadPatients(string ctr)
        {
            using (PatientMongoContext pmctx = new PatientMongoContext(ctr))
            {
                ...
                //foreach (MEPatient patient in patients)
                {
                    ...
                    parms.Add(new Parameter("@BackGround", (string.IsNullOrEmpty(patient.Background) ? string.Empty : patient.Background), SqlDbType.VarChar, ParameterDirection.Input, 50));
        ...
        private void LoadPatientGoals(string ctr)
        {
            using (PatientGoalMongoContext pgctx = new PatientGoalMongoContext(ctr))
            {
                ...
                //foreach (MEPatientGoal goal in goals)
                {
                    ...
                    parms.Add(new Parameter("@Name", (string.IsNullOrEmpty(goal.Name.ToString()) ? string.Empty : goal.Name.ToString()), SqlDbType.VarChar, ParameterDirection.Input, 50));
                    parms.Add(new Parameter("@Description", goal.Description == null ? string.Empty : goal.Description.ToString(), SqlDbType.VarChar, ParameterDirection.Input, 50));
        ...
        private void LoadPatientInterventions(string ctr)
        {
            using (PatientGoalMongoContext pgctx = new PatientGoalMongoContext(ctr))
            {
                ...
                foreach (MEPatientIntervention intervention in interventions)
                {
                    ...
                    parms.Add(new Parameter("@Status", (string.IsNullOrEmpty(intervention.Status.ToString()) ? string.Empty : intervention.Status.ToString()), SqlDbType.VarChar, ParameterDirection.Input, int.MaxValue));
                    ...
                    parms.Add(new Parameter("@Description", (string.IsNullOrEmpty(intervention.Description.ToString()) ? string.Empty : intervention.Description.ToString()), SqlDbType.VarChar, ParameterDirection.Input, int.MaxValue));
                ...
                using (ProgramMongoContext pmctx = new ProgramMongoContext(ctr))
                {
                    ...
                    Parallel.ForEach(programs, new ParallelOptions{MaxDegreeOfParallelism= Environment.ProcessorCount * _exponent}, prog =>
                    {
                        try
                        {
                            ...
                            parms.Add(new Parameter("@AssignedBy", prog.AssignedBy == null ? string.Empty : prog.AssignedBy.ToString(), SqlDbType.VarChar, ParameterDirection.Input, 50));
                            ...
                            parms.Add(new Parameter("@AssignedToId", prog.AssignedTo == null ? string.Empty : prog.AssignedTo.ToString(), SqlDbType.VarChar, ParameterDirection.Input, 50));
                            ...
                            parms.Add(new Parameter("@CompletedBy", prog.CompletedBy == null ? string.Empty: prog.CompletedBy, SqlDbType.VarChar, ParameterDirection.Input, 50));
                            parms.Add(new Parameter("@DateCompleted", prog.DateCompleted == null ? string.Empty : prog.DateCompleted.ToString(), SqlDbType.VarChar, ParameterDirection.Input, 50));
            ...
            try
            {
                    foreach (Module mod in list)
                    {
                        try
                        {
                            ...
                            parms.Add(new Parameter("@AssignedBy", mod.AssignedBy == null ? string.Empty : mod.AssignedBy.ToString(), SqlDbType.VarChar, ParameterDirection.Input, 50));
                            ...
                            parms.Add(new Parameter("@CompletedBy", mod.CompletedBy ?? string.Empty, SqlDbType.VarChar, ParameterDirection.Input, 50));
            ...
            try
            {
                    foreach (Action act in list)
                    {
                        try
                        {
                            ...
                            parms.Add(new Parameter("@AssignedBy", act.AssignedBy == null ? string.Empty : act.AssignedBy.ToString(), SqlDbType.VarChar, ParameterDirection.Input, 50));
                            ...
                            parms.Add(new Parameter("@CompletedBy", act.CompletedBy ?? string.Empty, SqlDbType.VarChar, ParameterDirection.Input, 50));
            ...
            try
            {
                    foreach (Step step in list)
                    {
                        try
                        {
                            ...
                            parms.Add(new Parameter("@CompletedBy", step.CompletedBy ?? string.Empty, SqlDbType.VarChar, ParameterDirection.Input, 50));
