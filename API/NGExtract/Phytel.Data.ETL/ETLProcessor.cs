                ...
                using (PatientGoalMongoContext pgctx = new PatientGoalMongoContext(ctr))
                {
                    ...
                    //foreach (MEPatientBarrier bar in barriers)//.Where(t => !t.DeleteFlag))
                    {
                        try
                        {
                            ...
                            parms.Add(new Parameter("@Details", (string.IsNullOrEmpty(bar.Details) ? string.Empty : bar.Details), SqlDbType.VarChar, ParameterDirection.Input, 5000));
                ...
                #region old
                    ...
                    //foreach (MEPatientGoal goal in goals)//.Where(t => !t.DeleteFlag))
                    {
                        try
                        {
                            ...
                            parms.Add(new Parameter("@Details", (string.IsNullOrEmpty(goal.Details) ? string.Empty : goal.Details), SqlDbType.VarChar, ParameterDirection.Input, 5000));
                    ...
                    //foreach (MEPatientIntervention intervention in interventions)//.Where(t => !t.DeleteFlag))
                    {
                        try
                        {
                            ...
                            { 
                                ...
                                parms.Add(new Parameter("@Details", (string.IsNullOrEmpty(intervention.Details) ? string.Empty : intervention.Details), SqlDbType.VarChar, ParameterDirection.Input, 5000));
                ...
                Parallel.ForEach(tasks, task =>
                    //foreach (MEPatientTask task in tasks.Where(t => !t.DeleteFlag))
                    {
                        try
                        {
                            ...
                            parms.Add(new Parameter("@Details", (string.IsNullOrEmpty(task.Details) ? string.Empty : task.Details), SqlDbType.VarChar, ParameterDirection.Input, 5000));
