...
{
    [Route("/{Context}/{Version}/Contract/{ContractNumber}/Programlist", "POST")]
    [Route("/{Context}/{Version}/Contract/{ContractNumber}/Programlist/Program/{ProgramNounID}", "GET")]
    public class ProgramListRequest : IDataDomainRequest
    {
        /*
