...
{
    public class StubMongoPatientProgramAttributeRepository : IProgramRepository
    {
        string userId = "testuser";
        public StubMongoPatientProgramAttributeRepository(string contract)
        {
        }
        ...
        {
            MEProgramAttribute pa = new MEProgramAttribute(userId)
            {
            };
            return pa;
        }
