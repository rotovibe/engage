...
{
    [Api(Description = "A Request object to get a YesNo Step by it's ID from the API.")]
    [Route("/{Context}/{Version}/{ContractNumber}/Step/{StepID}", "GET")]
    public class GetYesNoStepDataRequest : IDataDomainRequest
    {
        [ApiMember(Name = "YesNoStepID", Description = "ID of the YesNo Step being requested", ParameterType = "path", DataType = "string", IsRequired = true)]
        public string YesNoStepID { get; set; }
