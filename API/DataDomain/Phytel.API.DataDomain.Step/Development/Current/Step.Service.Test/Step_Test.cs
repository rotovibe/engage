...
namespace Phytel.API.DataDomain.Step.Services.Test
{
    ...
    public class User_Services_Test
    {
        ...
        public void GetStepByID()
        {
            ...
            StepResponse response = client.Post<StepResponse>("http://localhost:8888/NG/data/Step",
                new StepRequest { StepID = StepID, ContractNumber = contractNumber, Context = context } as object);
