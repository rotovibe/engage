...
{
    [Api]
    [Route("/{Context}/{Version}/{ContractNumber}/CohortPatientView/Patients/{Id}/PCM", "DELETE")]
    public class RemovePCMFromCohortPatientViewDataRequest : IDataDomainRequest
    {
