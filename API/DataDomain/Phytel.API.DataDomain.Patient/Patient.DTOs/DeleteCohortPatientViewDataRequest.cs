...
namespace Phytel.API.DataDomain.Patient.DTO
{
    ...
    public class DeleteCohortPatientViewDataRequest : IDataDomainRequest
    {
        ...
        [ApiMember(Name = "PatientId", Description = "Id of the patient whose cohort patient view record needs to be deleted", ParameterType = "property", DataType = "string", IsRequired = true)]
