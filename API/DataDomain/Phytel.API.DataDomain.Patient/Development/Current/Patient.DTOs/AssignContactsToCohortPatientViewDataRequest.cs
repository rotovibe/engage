...
{
    [Api]
    [Route("/{Context}/{Version}/{ContractNumber}/CohortPatientView/Patients/{Id}/Assign", "PUT")]
    public class AssignContactsToCohortPatientViewDataRequest : IDataDomainRequest
    {
        ...
        public List<string> ContactIdsToAssign { get; set; }
