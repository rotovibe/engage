...
namespace Phytel.API.DataDomain.Contact.Test
{
    ...
    public class ContactTest
    {
        ...
        //    phones.Add(new PhoneData { Id = "52ebf4b6d433230b0cf8780e", IsText = false, Number = "1111111111", OptOut = false, PhonePreferred = true, TextPreferred = false, SubTypeId = "52e18c2ed433232028e9e3a6" });
         ...
         //   emails.Add(new EmailData { Id = "52ebf4bad433230b0cf87810", Text = "snehal@phytel.com", SubTypeId = "52e18c2ed433232028e9e3a6", OptOut = false, Preferred = true });
            //emails.Add(new EmailData { Id = "-1", Text = "ingavale@phytel.com", SubTypeId = "52e18c32d433232028e9e3a7", OptOut = false, Preferred = true });
          ...
          //  addresses.Add(new AddressData { Id = "-52ebf4c0d433230b0cf87812", Line1 = "line1", Line2 = "line2", Line3 = "", City = "dallas", PostalCode = "", StateId = "52e195b8d433232028e9e3e4", SubTypeId = "52e18c2ed433232028e9e3a6", OptOut = false, Preferred = true });
           ...
           // List<EmailData> emails = new List<EmailData>();
           // emails.Add(new EmailData { Id = "52f3f3bfd6a48506c47612ab", OptOut = false, Preferred = true, SubTypeId = "52e18c32d433232028e9e3a7", Text = "test1@gmail.com" });
           //// emails.Add(new EmailData { Id = "52e75855d43323149870c229", OptOut = false, Preferred = false, SubTypeId = "52e18c41d433232028e9e3aa", Text = "test2@gmail.com" });
           // request.Emails = emails;
