...
{
    [Route("/{Context}/{Version}/{ContractNumber}/Contacts/{ContactId}/CareTeams/{Id}", "DELETE")]
    [Api(Description = "A Request object to delete a care team.")]
    public class DeleteCareTeamDataRequest : IDataDomainRequest
    {
        [ApiMember(Name = "ContactId", Description = "Id of the contact whose care team needs to be deleted.", ParameterType = "path", DataType = "string", IsRequired = true)]
        public string ContactId { get; set; }

        [ApiMember(Name = "Id", Description = "Id of the care team that needs to be deleted.", ParameterType = "path", DataType = "string", IsRequired = true)]
