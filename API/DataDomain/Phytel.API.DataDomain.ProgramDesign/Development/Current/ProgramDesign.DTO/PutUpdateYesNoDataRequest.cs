...
{
    [Api(Description = "A Request object to update a YesNo Step to the API.")]
    [Route("/{Context}/{Version}/{ContractNumber}/ProgramDesign/YesNoStep/{StepId}/Update", "PUT")]
    public class PutUpdateYesNoStepDataRequest : IDataDomainRequest
    {
        [ApiMember(Name = "StepId", Description = "Id of the YesNo Step being inserted", ParameterType = "path", DataType = "string", IsRequired = true)]
