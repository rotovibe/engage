...
namespace Phytel.API.DataDomain.CareMember.DTO
{
    ...
    public class PutCareMemberDataRequest : IDataDomainRequest
    {
        [ApiMember(Name = "PatientId", Description = "Id of the patient", ParameterType = "property", DataType = "string", IsRequired = true)]
        public string PatientId { get; set; }

        [ApiMember(Name = "CareMember", Description = "CareMember object to be inserted", ParameterType = "property", DataType = "CareMemberData", IsRequired = true)]
