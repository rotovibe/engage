...
{
    [Route("/{Context}/{Version}/{ContractNumber}/Patient/{PatientId}/Goal/{PatientGoalId}/Barrier/Initialize", "PUT")]
    public class PutInitializeBarrierDataRequest : IDataDomainRequest
    {
