...
{
    [Route("/{Context}/{Version}/{ContractNumber}/Goal/{PatientGoalId}", "GET")]
    public class GetPatientGoalDataRequest : IDataDomainRequest
    {
        [ApiMember(Name = "PatientGoalId", Description = "ID of the PatientGoal being requested", ParameterType = "property", DataType = "string", IsRequired = true)]
