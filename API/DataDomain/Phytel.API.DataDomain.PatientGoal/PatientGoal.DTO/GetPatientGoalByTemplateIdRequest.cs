...
{
    [Route("/{Context}/{Version}/{ContractNumber}/Patient/{PatientId}/Goal/", "GET")]
    public class GetPatientGoalByTemplateIdRequest : IDataDomainRequest
    {
        [ApiMember(Name = "TemplateId", Description = "Template ID of the PatientGoal being requested", ParameterType = "property", DataType = "string", IsRequired = true)]
