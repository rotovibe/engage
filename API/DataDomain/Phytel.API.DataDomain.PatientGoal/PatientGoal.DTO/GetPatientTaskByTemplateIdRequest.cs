...
{
    [Route("/{Context}/{Version}/{ContractNumber}/Patient/{PatientId}/Goal/Tasks/", "GET")]
    public class GetPatientTaskByTemplateIdRequest : IDataDomainRequest
    {
        [ApiMember(Name = "TemplateId", Description = "Template ID of the patientTask being requested", ParameterType = "property", DataType = "string", IsRequired = true)]
