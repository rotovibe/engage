...
{
    [Route("/{Context}/{Version}/{ContractNumber}/Patient/{PatientId}/Problem/Update", "PUT")]
    public class PutUpdatePatientProblemRequest : IDataDomainRequest
    {
        [ApiMember(Name = "Id", Description = "Id of the problem registration", ParameterType = "property", DataType = "string", IsRequired = false)]
