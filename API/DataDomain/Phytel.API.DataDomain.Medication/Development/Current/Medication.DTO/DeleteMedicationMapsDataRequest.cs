...
namespace Phytel.API.DataDomain.Medication.DTO
{
    ...
    {
        [ApiMember(Name = "Ids", Description = "Comma limited MedicationMap Ids that need to be deleted.", ParameterType = "property", DataType = "string", IsRequired = true)]
        public string Ids { get; set; }

        [ApiMember(Name = "Id", Description = "MedicationMap Id.", ParameterType = "property", DataType = "string", IsRequired = false)]
