...
namespace Phytel.API.DataDomain.Medication.DTO
{
    ...
    public class DeletePatientMedSuppDataRequest : IDataDomainRequest
    {
        [ApiMember(Name = "Id", Description = "PatientMedSupp Id", ParameterType = "property", DataType = "string", IsRequired = true)]
