...
namespace Phytel.API.DataDomain.Module.Services.Test
{
    ...
    public class User_Services_Test
    {
        ...
        public void GetModuleByID()
        {
            ...
            ModuleResponse response = client.Post<ModuleResponse>("http://localhost:8888/NG/data/Module",
                new ModuleRequest { ModuleID = ModuleID, ContractNumber = contractNumber, Context = context } as object);
