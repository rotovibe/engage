...
{
    [Route("/{Context}/{Version}/Contract/{ContractNumber}/Module", "POST")]
    [Route("/{Context}/{Version}/Contract/{ContractNumber}/Module/{ModuleID}", "GET")]
    public class ModuleRequest : IDataDomainRequest
    {
