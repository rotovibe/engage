...
namespace Phytel.API.DataDomain.Action.Services.Test
{
    ...
    public class User_Services_Test
    {
        ...
        public void GetActionByID()
        {
            ...
            ActionResponse response = client.Post<ActionResponse>("http://localhost:8888/NG/data/Action",
                new ActionRequest { ActionID = ActionID, ContractNumber = contractNumber, Context = context } as object);
