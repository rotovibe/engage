...
{
    [Route("/{Context}/{Version}/Contract/{ContractNumber}/Action", "POST")]
    [Route("/{Context}/{Version}/Contract/{ContractNumber}/Action/{ActionID}", "GET")]
    public class ActionRequest : IDataDomainRequest
    {
