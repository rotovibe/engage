...
namespace Phytel.API.DataDomain.Allergy.DTO
{
    ...
    public class DeletePatientAllergyDataRequest : IDataDomainRequest
    {
        [ApiMember(Name = "Id", Description = "PatientAllergy Id", ParameterType = "property", DataType = "string", IsRequired = true)]
