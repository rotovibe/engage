...
{
    [Api(Description = "A Request object to update a patient Barrier.")]
    [Route("/{Version}/{ContractNumber}/Patient/{PatientId}/Goal/{PatientGoalId}/Barrier/{Id}/Update", "POST")]
    public class PostPatientBarrierRequest : IAppDomainRequest
    {
        ...
        [ApiMember(Name = "Id", Description = "Barrier Id", ParameterType = "property", DataType = "string", IsRequired = true)]
        public string Id { get; set; }

        [ApiMember(Name = "Barrier", Description = "Barrier being updated", ParameterType = "body", DataType = "PatientBarrier", IsRequired = true)]
        public PatientBarrier Barrier { get; set; }
