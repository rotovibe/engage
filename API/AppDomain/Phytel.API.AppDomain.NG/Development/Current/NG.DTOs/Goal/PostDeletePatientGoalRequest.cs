...
namespace Phytel.API.AppDomain.NG.DTO
{
    ...
    [Route("/{Version}/{ContractNumber}/Patient/{PatientId}/Goal/{PatientGoalId}/Delete", "POST")]
    public class PostDeletePatientGoalRequest : IAppDomainRequest
    {
        ...
        public PostDeletePatientGoalRequest() { }
    }
}
