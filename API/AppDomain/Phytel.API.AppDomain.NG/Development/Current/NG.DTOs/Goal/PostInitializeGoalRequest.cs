...
{
    [Route("/{Version}/{ContractNumber}/Patient/{PatientId}/Goal/Initialize", "POST")]
    public class PostInitializeGoalRequest : IAppDomainRequest
    {
        ...
        public PostInitializeGoalRequest() { }
    }
}
