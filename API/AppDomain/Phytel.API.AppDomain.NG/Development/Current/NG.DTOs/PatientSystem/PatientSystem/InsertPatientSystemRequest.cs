...
{
    [Route("/{Version}/{ContractNumber}/Patient/{PatientId}/PatientSystem", "POST")]
    public class InsertPatientSystemRequest : IAppDomainRequest
    {
        ...
        [ApiMember(Name = "PatientSystem", Description = "PatientSystem that need to be inserted.", ParameterType = "property", DataType = "PatientSystem", IsRequired = true)]
        ...
        public InsertPatientSystemRequest() { }
    }
}