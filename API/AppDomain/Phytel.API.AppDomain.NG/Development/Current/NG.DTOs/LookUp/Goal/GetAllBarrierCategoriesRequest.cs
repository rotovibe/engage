...
{
     [Route("/{Version}/{ContractNumber}/lookup/barriercategories", "GET")]
    public class GetAllBarrierCategoriesRequest : IAppDomainRequest
    {
        ...
        public GetAllBarrierCategoriesRequest() { }
    }
}
