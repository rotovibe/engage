...
{
     [Route("/{Version}/{ContractNumber}/lookup/interventioncategories", "GET")]
    public class GetAllInterventionCategoriesRequest : IAppDomainRequest
    {
        ...
        public GetAllInterventionCategoriesRequest() { }
    }
}
