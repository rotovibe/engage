...
namespace Phytel.API.AppDomain.NG
{
    public interface IPlanElementUtils
    {
        ...
        bool ModifyProgramAttributePropertiesForUpdate(Phytel.API.DataDomain.Program.DTO.ProgramAttributeData pAtt, Phytel.API.DataDomain.Program.DTO.ProgramAttributeData _pAtt);
        ...
        void SaveReportingAttributes(Phytel.API.DataDomain.Program.DTO.ProgramAttributeData _programAttributes, Phytel.API.Interface.IAppDomainRequest request);
