...
{
    [Route("/{Version}/{ContractNumber}/Patient/{PatientId}/Goal/Initialize", "GET")]
    public class GetInitializeGoalRequest : IAppDomainRequest
    {
        ...
        public GetInitializeGoalRequest() { }
    }
}
