...
{
    [Route("/{Version}/{ContractNumber}/Patient/{PatientId}/Goal/{PatientGoalId}/Barrier/Initialize", "GET")]
    public class GetInitializeBarrierRequest : IAppDomainRequest
    {
        ...
        public GetInitializeBarrierRequest() { }
    }
}
