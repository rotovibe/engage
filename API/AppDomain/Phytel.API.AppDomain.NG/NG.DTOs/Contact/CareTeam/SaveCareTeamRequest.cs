...
{
    [Route("/{Version}/{ContractNumber}/Contacts/{ContactId}/CareTeams", "POST")]
    [Api(Description = "A Request object to Save the CareTeam for a contact")]
    public class SaveCareTeamRequest : IAppDomainRequest
    {
