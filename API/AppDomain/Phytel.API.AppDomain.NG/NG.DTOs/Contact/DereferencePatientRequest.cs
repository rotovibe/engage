...
{
    public class DereferencePatientRequest : IAppDomainRequest
    {
        [ApiMember(Name = "PatientId", Description = "Id of the user logged in.", ParameterType = "property", DataType = "string", IsRequired = true)]
