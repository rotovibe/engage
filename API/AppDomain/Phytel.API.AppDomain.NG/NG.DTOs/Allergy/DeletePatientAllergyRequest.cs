...
namespace Phytel.API.AppDomain.NG.DTO
{
    ...
    public class DeletePatientAllergyRequest : IAppDomainRequest
    {
        [ApiMember(Name = "Id", Description = "Patient Id", ParameterType = "property", DataType = "string", IsRequired = true)]
        public string PatientId { get; set; }

        [ApiMember(Name = "Id", Description = "PatientAllergy Id that need to be deleted.", ParameterType = "property", DataType = "string", IsRequired = true)]
        ...
        public DeletePatientAllergyRequest() { }
    }
}