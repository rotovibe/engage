...
{
    [Api(Description = "A Request object to retrieve the current problems for this patient.")]
    [Route("/{Version}/{ContractNumber}/Patient/{PatientId}/Observation/Problems", "GET")]
    public class GetPatientProblemsRequest : IAppDomainRequest
    {
