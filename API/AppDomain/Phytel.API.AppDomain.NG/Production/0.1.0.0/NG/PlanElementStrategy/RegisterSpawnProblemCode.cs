...
namespace Phytel.API.AppDomain.NG.PlanElementStrategy
{
    public class RegisterSpawnProblemCode : ISpawn
    {
        ...
        public RegisterSpawnProblemCode(PlanElementEventArg e, SpawnElement rse, PatientProblemData ppd)
        {
            _e = e;
            _se = rse;
        }
        ...
        public void Execute()
        {
            ...
            PutNewPatientProblemResponse response = PlanElementEndpointUtil.PutNewPatientProblem(_e.PatientId, _e.UserId, _se.ElementId, _e.DomainRequest);
        }
    }
}
