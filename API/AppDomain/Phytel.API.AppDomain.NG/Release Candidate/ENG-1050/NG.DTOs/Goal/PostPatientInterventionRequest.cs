...
{
    [Api(Description = "A Request object to update a patient intervention.")]
    [Route("/{Version}/{ContractNumber}/Patient/{PatientId}/Goal/{PatientGoalId}/Intervention/{Id}/Update", "POST")]
    public class PostPatientInterventionRequest : IAppDomainRequest
    {
        ...
        [ApiMember(Name = "Intervention", Description = "Intervention being updated", ParameterType = "body", DataType = "PatientIntervention", IsRequired = true)]
