...
{
    [Api(Description = "A Request object to get all states from the API.")]
    [Route("/api/{Context}/{Version}/{ContractNumber}/states", "GET")]
    public class GetAllStatesDataRequest : IDataDomainRequest
    {
