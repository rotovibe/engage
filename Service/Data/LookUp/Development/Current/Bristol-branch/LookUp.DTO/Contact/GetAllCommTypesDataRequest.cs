...
{
    [Api(Description = "A Request object to get all communication types from the API.")]
    [Route("/api/{Context}/{Version}/{ContractNumber}/commtypes", "GET")]
    public class GetAllCommTypesDataRequest : IDataDomainRequest
    {
