...
{
    [Route("/api/{Context}/{Version}/{ContractNumber}/Patient/{PatientId}/PatientSystem", "DELETE")]
    public class DeletePatientSystemByPatientIdDataRequest : IDataDomainRequest
    {
