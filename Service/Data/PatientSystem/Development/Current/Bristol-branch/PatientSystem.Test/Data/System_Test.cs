...
namespace Phytel.API.DataDomain.PatientSystem.Test
{
    ...
    public class System_Test
    {
        ...
        public void GetSystemSources_Test()
        {
            ...
            GetSystemsDataResponse response = client.Get<GetSystemsDataResponse>(string.Format("{0}/api/{1}/{2}/{3}/System?UserId={4}", url, context, version, contractNumber, request.UserId));
