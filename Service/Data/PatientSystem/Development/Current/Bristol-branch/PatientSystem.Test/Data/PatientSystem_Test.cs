...
namespace Phytel.API.DataDomain.PatientSystem.Test
{
    ...
    public class PatientSystem_Test
    {
        ...
        public void GetPatientSystems_Test()
        {
            ...
            GetSystemsDataResponse response = client.Get<GetSystemsDataResponse>(string.Format("{0}/api/{1}/{2}/{3}/Patient/{4}/PatientSystems?UserId={5}", url, context, version, contractNumber, request.PatientId, request.UserId));
        ...
        public void InsertPatientSystem_Test()
        {
            ...
            InsertPatientSystemsDataResponse response = client.Post<InsertPatientSystemsDataResponse>(string.Format("{0}/api/{1}/{2}/{3}/Patient/{4}/PatientSystem", url, context, version, contractNumber, request.PatientId), request);
            Assert.IsNotNull(response);
        }
        ...
        public void InsertPatientSystems_Test()
        {
            ...
            InsertPatientSystemsDataResponse response = client.Post<InsertPatientSystemsDataResponse>(string.Format("{0}/api/{1}/{2}/{3}/Patient/{4}/PatientSystems", url, context, version, contractNumber, request.PatientId), request);
            Assert.IsNotNull(response);
        }
        [TestMethod]
        public void UpdatePatientSystems_Test()
        {
            ...
            UpdatePatientSystemsDataResponse response = client.Put<UpdatePatientSystemsDataResponse>(string.Format("{0}/api/{1}/{2}/{3}/Patient/{4}/PatientSystems", url, context, version, contractNumber, request.PatientId), request);
            Assert.IsNotNull(response);
        }
        ...
        public void DeletePatientSystems_Test()
        {
            ...
            DeletePatientSystemsDataResponse response = client.Delete<DeletePatientSystemsDataResponse>(string.Format("{0}/api/{1}/{2}/{3}/Patient/{4}/PatientSystems/{5}?UserId={6}", url, context, version, contractNumber, request.PatientId, request.Ids,request.UserId));
            Assert.IsNotNull(response);
        }
