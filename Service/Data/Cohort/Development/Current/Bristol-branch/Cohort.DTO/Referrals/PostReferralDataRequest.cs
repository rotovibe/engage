...
{
    [Route("/{Context}/{Version}/{ContractNumber}/Cohorts/Referrals", "POST")]
    public class PostReferralDefinitionRequest : IDataDomainRequest
    {
        [ApiMember(Name = "Referral", Description = "Referral entity", ParameterType = "property", DataType = "ReferralData", IsRequired = true)]
