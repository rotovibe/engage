...
{
    [Route("/api/{Context}/{Version}/{ContractNumber}/PatientReferrals", "POST")]
    public class PostPatientReferralDefinitionRequest : IDataDomainRequest
    {
        [ApiMember(Name = "PatientReferral", Description = "Json should look like { 'patientReferral' : { put body here }}", ParameterType = "body", DataType = "PatientReferralData", IsRequired = true)]
