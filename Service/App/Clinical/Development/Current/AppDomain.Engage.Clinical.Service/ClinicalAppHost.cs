...
{
    public class ClinicalAppHost : AppHostBase
    {
        public ClinicalAppHost() : base("Engage Clinical Integration Services", Assembly.GetExecutingAssembly()) { }
        ...
        public override void Configure(Funq.Container container)
        {
            ...
            auditLogger.DomainName = "Engage Clinical Integration Services";
