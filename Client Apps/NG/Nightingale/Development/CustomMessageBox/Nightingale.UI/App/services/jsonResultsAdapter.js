...
define([], new breeze.JsonResultsAdapter({
    ...
    visitNode: function (node, mappingContext, nodeContext) {
        ...
        if (node.SystemId && node.SystemName) {
