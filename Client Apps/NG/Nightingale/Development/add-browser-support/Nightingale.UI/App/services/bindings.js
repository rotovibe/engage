            ...
            init: function (element, valueAccessor, allBindingsAccessor) {
                ...
                if (!isChrome()) {
                    ...
                    function setHeights($el) {
                        ...
                        $widgets.children('.content').css('height', '');
                        $widgets.each(function () {
                            var $content, $widget, height;
                            $widget = $(this);
                            $content = $widget.children('.content');
                            ...
                            return $content.find('.wrapper > .content').css('height', height + "px");
                        });
                        $contents = $widgets.find('.content > .table-row > .table-cell > .body');
                        $contents.css('height', '');
                        return $contents.each(function () {
                            var $body, height;
                            $body = $(this);
                            height = $body.parent().height();
