define(['config.models', 'viewmodels/patients/index'],
    function (modelConfig, patientsIndex) {
        ...
        ctor.prototype.createQuickAddSections = function () {
            ...
            self.quickAddSections.push(new modelConfig.quickAddSection('assign', 'Assign Patient', 'icon-assign-patient', 'viewmodels/shell/quickadd/assign'));
