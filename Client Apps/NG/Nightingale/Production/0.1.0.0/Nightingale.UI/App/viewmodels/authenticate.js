define(['services/session', 'config.routes', 'plugins/router', 'services/datacontext'],
    function (session, routeConfig, router, datacontext) {
        ...
        function getUserSessionByToken(tokenId) {
            ...
            token = session.currentUser.subscribe(function () {
                if (session.currentUser()) {
                    datacontext.createCalendarMocks();
