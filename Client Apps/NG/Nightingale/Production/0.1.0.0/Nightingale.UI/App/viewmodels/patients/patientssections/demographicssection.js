define(['durandal/app', 'viewmodels/shell/shell', 'config.models', 'services/datacontext'],
    function (app, shell, modelConfig, datacontext) {
        ...
        ctor.prototype.activate = function (settings) {
            ...
            self.modal = new modelConfig.modal('Edit Patient', self.selectedPatient, 'templates/patient.html', self.editModalShowing);
