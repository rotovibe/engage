define(['services/session', 'config.models', 'config.services', 'config.models.user', 'services/dataservices/usersservice', 'services/dataservices/calendarservice'],
    function (session, modelConfig, servicesConfig, userModelConfig, userService, calendarService) {
        ...
        var getEventsByUserId = function (eventsObservable, userId, forceRemote) {
            ...
            return calendarService.getEventsByUserId(manager, resource, eventsObservable, apiToken(), userId, forceRemote);
        };

        // Go create calendar event for this user
        var createCalendarEvent = function (params) {
            return calendarService.createCalendarEvent(manager, currentUserId(), params);
        };
