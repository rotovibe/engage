...
//Possible IE7 Div z-index issue fix
...
$(function () {
    ...
    $('div').each(function () {
        if ($(this).hasClass('ui-widget-overlay')) {
            if (this.document) {
                $(this).css('height', this.document.body.clientHeight);
            }
        }
    });

    var main = $('#main');
    if (main.hasClass('noZIndexFix')) {
        return;
    }
    if ($.browser.msie && jQuery.browser.version == '7.0') {
        ...
        $('div').each(function () {
            ...
            zmax = cur > 999 ? cur : zIndexNumber;

            $(this).css('z-index', zmax);
            zIndexNumber -= 10;
        });
        $('#updateProgressWidgetOverlay').css('z-index', 10001);
        $('#updateProgressLoadingMessage').css('z-index', 10001);
    }
});
    ...
    $.widget("ech.multiselect", {
        ...
        _bindEvents: function () {
			...
			.delegate('input[type="checkbox"], input[type="radio"]', 'click.multiselect', function (e) {
			    ...
			    // bail if this input is disabled or the event is canceled
