        ...
        scroll = o.scroll;
          ...
          .css({
              ...
              zIndex: 99
                ...
                // on bar over
                bar.hover(function () {
                    $('#Template1, #Template2, #Template3, #Template4, #Template5, #Template6').draggable('disable');
                    $("#widgetInner").dragsort("destroy");
                    isOverBar = true;
                }, function () {
                    isOverBar = false;
                    $('#Template1, #Template2, #Template3, #Template4, #Template5, #Template6').draggable('enable');
                    $("#widgetInner").dragsort({ dragSelector: "div", dragBetween: true, dragEnd: saveOrder, placeHolderTemplate: "<li class='placeHolder'><div></div></li>" });
                });
