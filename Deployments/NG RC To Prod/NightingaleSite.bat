...
tf branch "$/PhytelCode/Phytel.Net/Client Apps/NG/Nightingale/Production/Current" "$/PhytelCode/Phytel.Net/Client Apps/NG/Nightingale/Production/%branchDate%" /checkin /noprompt /silent
