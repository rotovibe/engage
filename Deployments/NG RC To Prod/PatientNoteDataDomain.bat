...
TFSBuild start http://hillstfs2013:8080/tfs PhytelCode "API Patient Note Data Domain (Prod Svr1)" /silent
TFSBuild start http://hillstfs2013:8080/tfs PhytelCode "API Patient Note Data Domain (Prod Svr2)" /silent
