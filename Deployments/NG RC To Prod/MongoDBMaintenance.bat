...
tf branch "$/PhytelCode/Phytel.Net/Internal Tools/MongoDBMaintenance/Production/Current" "$/PhytelCode/Phytel.Net/Internal Tools/MongoDBMaintenance/Production/%branchDate%" /checkin /noprompt /silent
