...
tf branch "$/PhytelCode/Phytel.Net/Services/API/DataDomain/Phytel.API.DataDomain.Action/Production/Current" "$/PhytelCode/Phytel.Net/Services/API/DataDomain/Phytel.API.DataDomain.Action/Production/%branchDate%" /checkin /noprompt /silent
...
TFSBuild start http://hillstfs2013:8080/tfs PhytelCode "API Action Data Domain (Prod Svr1)" /silent
TFSBuild start http://hillstfs2013:8080/tfs PhytelCode "API Action Data Domain (Prod Svr2)" /silent
