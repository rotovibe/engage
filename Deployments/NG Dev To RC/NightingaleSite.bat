...
REM tf branch "$/PhytelCode/Phytel.Net/Client Apps/NG/Nightingale/Release Candidate/Current" "$/PhytelCode/Phytel.Net/Client Apps/NG/Nightingale/Release Candidate/%branchDate%" /checkin /noprompt /silent
