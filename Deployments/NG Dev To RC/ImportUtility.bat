...
tf branch "$/PhytelCode/Phytel.Net/Services/API/Import/Release Candidate/Current" "$/PhytelCode/Phytel.Net/Services/API/Import/Release Candidate/%branchDate%" /checkin /noprompt /silent
