...
tf branch "$/PhytelCode/Phytel.Net/Services/API/DataDomain/Phytel.API.DataDomain.LookUp/Release Candidate/Current" "$/PhytelCode/Phytel.Net/Services/API/DataDomain/Phytel.API.DataDomain.LookUp/Release Candidate/%branchDate%" /checkin /noprompt /silent
...
TFSBuild start http://hillstfs2013:8080/tfs PhytelCode "API Lookup Data Domain (RC)" /silent
