...
namespace Phytel.Services.Communication
{
    ...
    {
        TemplateResults BuildAppointmentSpecificMessage(System.Xml.XmlDocument xdoc, EmailActivityDetail emailActivityDetail, System.Collections.Generic.List<ActivityMedia> activityMediaList, System.Collections.Hashtable missingObjects, int contactRoleID, int templateID, System.Collections.Generic.List<ContractPermission> contractPermissionRecords);
        ...
        TemplateResults BuildEmailFacility(System.Xml.XmlDocument xdoc, EmailActivityDetail emailActivityDetail, System.Collections.Generic.List<ActivityMedia> activityMediaList, System.Collections.Hashtable missingObjects);
        TemplateResults BuildEmailMessage(System.Xml.XmlDocument xdoc, EmailActivityDetail emailActivityDetail, System.Collections.Generic.List<ActivityMedia> activityMediaList, System.Collections.Hashtable missingObjects, int campaignID, int contactRoleID, int templateID);
        ...
        TemplateResults BuildIntroEmailMessage(System.Xml.XmlDocument xdoc, EmailActivityDetail emailActivityDetail, System.Collections.Generic.List<ActivityMedia> activityMediaList, System.Collections.Hashtable missingObjects, int campaignID, int contactRoleID, int templateID);
