...
namespace Phytel.Framework.SQL
{
	/// <summary>
	...
	public class Converter
	{
        ...
        {
            return _converter.ToShort(source);
        }

        public static short ToShort(object source, short defaultValue)
        {
            return _converter.ToShort(source, defaultValue);
        }
        ...
        {
            return _converter.ToDate(date, format);
        }
