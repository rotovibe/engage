...
namespace Phytel.Framework.SQL.Cache
{
	...
	public class EnterpriseCache : ICache
	{
		...
		private EnterpriseCacheConfiguration _config;

		public EnterpriseCache( string name )
		{
			_config = new EnterpriseCacheConfiguration( name );
		}
		...
		public bool Put(object key, object value)
		{
			...
			_manager.Add(key.ToString(), value, CacheItemPriority.Normal, null, _config.GetExpirationByType( valueType ) );
